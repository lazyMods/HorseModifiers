package lazy.horsemodifiers.forge.configs;
...
public class ModConfigs {
    ...
    public static ConfigsHolder createHolder(){
        return new ConfigsHolder(CARROT_HEALTH_ADD_VALUE.get(), CARROT_JUMP_ADD_VALUE.get(), CARROT_SPEED_ADD_VALUE.get(), MAX_MODIFIERS_VALUE.get());
    }
